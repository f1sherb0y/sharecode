...
pub fn router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/api/config/registration", get(auth::get_registration_status))
        // Rooms
        ...
        .route("/api/rooms/by-document/{documentId}", get(rooms::get_room_by_document_id))
        ...
        .route("/api/rooms/{roomId}/share-links", post(share::create_share_link))
        .route("/api/rooms/{roomId}/share-links", get(share::list_share_links))
        .route(
